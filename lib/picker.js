...
var Picker = React.createClass({
  ...
  getCategories: function () {
    ...
    _.each(this.props.categories, function (details, key) {
      headers.push(React.createElement(
        ...
        React.createElement(Emoji, { id: key, href: `#${ details.title }`, shortname: ":" + details.emoji + ":", onClick: function () {
            jumpToCategory(key);
          }, onKeyUp: function (e) {
            e.preventDefault();
      ...
      if (list && Object.keys(list).length && i < this.state.rendered) {
        list = _.map(list, function (data) {
          ...
          if (!search || !term || modified.keywords.some(function (keyword) {
            ...
            return React.createElement(
              ...
              React.createElement(Emoji, { role: "option", onClick: function () {
                  onChange(modified);
                }, onKeyUp: function (e) {
                  e.preventDefault();
        ...
        if (_.compact(list).length) {
          sections.push(React.createElement(
            ...
            React.createElement(
              "h2",
              { refs: category.title, id: category.title, tabIndex: "0", className: "emoji-category-header" },
              category.title
            ),
            React.createElement(
              "ul",
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "emoji-grandlist", ref: "grandlist" },
        this.getSearchInput(),
        this.getEmojis()
      )
    );
